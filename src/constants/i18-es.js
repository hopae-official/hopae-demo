export default {
  ...
  "The City of Jeju Island": "La ciudad de Jeju Island",
  ...
  "The University of Jeju": "La Universidad de Jeju",
  ...
  "Jeju Island Transit": "Transporte Público de Jeju",
  ...
  "Jeju Museum of Modern Art": "Museo de Arte Moderno de Jeju",
  ...
  "back": "Atrás",
  "Hopae with uPort": "Iniciar Sesión con Hopae",
  ...
  "is going to send your new claims to your Hopae app": "va a enviar sus nuevos reclamos a su aplicación Hopae",
  ...
  "To login scan the QR code with the Hopae app": "Para iniciar sesión escanee el código QR con la aplicación Hopae",
  "You're logging in to": "Estás iniciando sesión en",
  "Tap to login with the Hopae app": "Toca para iniciar sesión con la aplicación Hopae",
  ...
  "agreeTnC": "Estoy de acuerdo con los <1>Términos y Condiciones</1> de Hopae",
  ...
  "regnSuccessText3": "enviará tus nuevas credenciales a tu aplicación Hopae",
  ...
  // Attestation
  "Scan this QR Code using the Hopae App": "Escanee este Código QR usando la aplicación Hopae",
  ...
  "Tap 'Accept' in your Hopae app to receive your claims": "Toque 'Accept' en su aplicación Hopae para recibir sus credenciales",

  // Success
  "Congratulations!": "¡Felicidades!",
  "You received your": "Haz recibido tu",
  "Your claims are stored in your Hopae app": "Tus credenciales están almacenadas en tu aplicación Hopae.",
  ...
  "Build user-centric trusted data apps with Hopae": "Cree aplicaciones de confianza de datos centradas en el usuario con Hopae",

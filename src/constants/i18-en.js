export default {
  ...
  // AppDownload
  "make sure you have your phone handy": "Psst... Make sure you have your phone handy with the Hopae app downloaded.",
  "make sure you have the Hopae app downloaded": "Psst... Make sure you have the Hopae app downloaded",
  ...
  "The City of Jeju Island": "The City of Jeju Island",
  ...
  "employmentStep1": "Login with Hopae",
  ...
  "insuranceStep1": "Login with Hopae",
  ...
  "pharmacyStep1": "Login with Hopae",
  "pharmacyStep2": "Get verified",
  "pharmacyStep3": "Receive Prescription Drug",

  "Jeju Island Transit": "Jeju Island Transit",
  "transportDisplayName": "Monthly Bus Ticket",
  "transportDescription": "Are you a Hopaeland citizen? Alumni of The Hopaeland University? Get your monthly bus ticket for free and enjoy the city transportation!",
  "transportStep1": "Login with Hopae",
  "transportStep2": "Get verified",
  "transportStep3": "Receive Monthly Bus Ticket",

  "Jeju Museum of Modern Art": "Jeju Museum of Modern Art",
  "museumDisplayName": "Annual Membership",
  "museumDescription": "Get a free membership with your City ID.",
  "museumStep1": "Login with Hopae",
  ...
  "back": "Back",
  "Login with Hopae": "Login with Hopae",
  ...
  "is going to send your new claims to your Hopae app": "",

  "regnLandingHeading": "Join thousands of fellow Hopaeland citizens!",
  ...
  // Login
  "Open the Hopae app to login": "Open the Hopae app to login",
  "Continue": "Continue",
  "First things first": "First things first",
  "To login scan the QR code with the Hopae app": "To login scan the QR code with the Hopae app",
  "You're logging in to": "You're logging in to",
  "Tap to login with the Hopae app": "Tap to login with the Hopae app",
  ...
  "agreeTnC": "I agree to the Hopae <1>Terms and Conditions</1>",
  ...
  "Any data that you enter is securely protected and encrypted": "Any data that you enter is securely protected and encrypted. It will be added as an attestation to your Hopae Identity (you can always delete it at any time).",
  ...
  "regnSuccessText2": "Let's make sure you have an access to your Hopaeland City ID whenever and wherever you need them.",
  "regnSuccessText3": "is going to send your new ID claims to your Hopae app.",
  ...
  // Attestation
  "Scan this QR Code using the Hopae App": "Scan this QR Code using the Hopae App",
  ...
  "Tap 'Accept' in your Hopae app to receive your claims": "Tap 'Accept' in your Hopae app to receive your claims",

  // Success
  "Congratulations!": "Congratulations!",
  "You received your": "You received your",
  "Your claims are stored in your Hopae app": "Your claims are stored in your Hopae app.",
  "Services that honor": "Services that honor",
  "Back to Dashboard": "Back to Dashboard",

  // Prerequisite
  "Uh, something went wrong": "Uh, something went wrong",
  "It seems like we couldn’t find required information in your Hopae app." : "It seems like we couldn’t find required information in your Hopae app.",

  // LikeDemo
  "Like the demo?": "Like the demo?",
  "Build user-centric trusted data apps with Hopae": "Build user-centric trusted data apps with Hopae",
  ...
  "You are leaving the Hopaeland dashboard":  "You are leaving the Hopaeland dashboard and will be automatically redirected to",
  ...
  // Transport
  "transportDetail1": "The City of Hopaeland provides free services for its citizens. Get your monthly bus ticket for free.",

  // Pharmacy
  "pharmacyDetail1": "Get your medicines at any drug store you wish. No need to wait for the doctor to call your pharmacy",

  // Museum
  "museumDetail1": "The City of Hopaeland provides free services for its citizens. Get your annual museum membership for free.",

export default {
  ...
  "To login scan the QR code with the uPort app": "Hopae 앱으로 스캔해서 로그인",
  "You're logging in to": "로그인하는 서비스",
  "Tap to login with the uPort app": "Hopae 앱으로 로그인 하려면 클릭",
  ...
  // City/ClaimExists
  "regnClaimExists": "It looks like you already have a Jeju City ID",

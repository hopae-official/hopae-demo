export default {
  // Header
  "Welcome to": "환영합니다,",
  "tryDemo": "새로운 인증방식을 경험해보세요",
  "Play around": "미래의 스마트 시티, 제주",
  "Get Started": "시작하기",
  "Its Simple": "간단한 절차",
  "getRegistration": "제주도민증을 발급받습니다",
  "getRegistrationDescription": "도청에서 당신의 정보를 \"검증하고\" 도민증을 발급합니다",
  "Store it in the uport app": "개인의 Hopae 앱에 저장합니다",
  ...
  "make sure you have the uport app downloaded": "꼭 핸드폰에 Hopae 앱을 다운로드 받으세요",

  //ServiceCard"
  "youll be asked to share": "다음 항목들을 공유하게 됩니다",
  "credential included": "개의 정보가 포함됩니다",
  "credentials included": "개의 정보가 포함됩니다",
  ...
  "School Name": "학교명",
  "Program Name": "전공 학과",
  "Graduation Year": "졸업년도",
  "Final Grades": "학점",
  "Salary": "연봉 (원천징수)",
  "Date of Employment": "취업일",
  "Company Name": "회사명",
  "First Name": "이름",
  "Last Name": "성",
  "Name": "이름",
  ...
  "City ID": "제주도민증",
  "Diploma": "졸업증명서",
  "Monthly Bus Ticket": "월정액 버스카드",
  "Prescription Drug": "처방전",
  "Annual Membership": "연간회원권",
  "Insurance Coverage": "의료보험",
  "Employment Verification": "재직증명서",

  "get your": "발급절차: ",
  "Receive your": "Receive your",
  "back": "Back",
  "Login with uPort": "Hopae로 로그인",
  "will ask you to share": ": 다음 항목들을 공유합니다",
  "Your claims were succesfully shared with": "성공적으로 제공한 정보를 공유했습니다:",
  "is going to send your new claims to your uPort app": "에서 새로운 인증서를 Hopae앱으로 보내드릴것입니다",

  "regnLandingHeading": "블록체인으로 인증하는 제주도민증을 발급받으세요!",
  "regnLandingStep1": "불필요한 보안프로그램이나 공인인증서가 필요 없습니다.",
  "regnLandingStep2": "도에서 도민들을 위해 제공하는 특별한 혜택들을 누리세요",
  "regnLandingStep3": "도에서 무료로 관광지들과 박물관들을 방문할 수 있는 연간 회원권을 제공합니다.",

  // Login
  "Open the uPort app to login": "Hopae앱을 열어서 로그인하세요",
  "Continue": "계속하기",
  "First things first": "시작하기전에 앞서..",
  "To login scan the QR code with the uPort app": "Hopae앱으로 스캔해서 로그인",
  "You're logging in to": "로그인하는 서비스",
  "Tap to login with the uPort app": "Hopae앱으로 로그인 하려면 클릭",
  "Don’t have the app? Download it from your store": "아직 앱이 없으신가요? 지금 바로 다운로드 하세요",
  "Issuer": "Issuer",
  "No information requested": "추가 인증정보가 없습니다",
  "This information will be shared with": "이 정보들은 다음 서비스에 공유됩니다: ",
  "Waiting for login": "로그인 대기중",
  "Refresh": "새로고침",
  "Loading": "로딩중",
  "Requested information": "요청된 인증정보",

  // Claims
  "regnFormHeading": "개인정보 입력",
  "regnFormLabel1": "제주도민증을 발급받기 위해 ",
  "regnFormLabel2": "에 제출할 정보를 입력하세요",
  "* indicates required field": "* 표시있는 부분은 필수입력",
  "This field is required": "이 부분은 꼭 입력해주세요",
  "agreeTnC": "<1>개인정보 이용약관</1>에 동의합니다.",
  "You must accept the terms and Conditions": "개인정보 이용약관에 동의하셔야 합니다",
  "What's next?": "What's next?",
  "Your information will be verified": "입력하신 정보는 기존 정보를 바탕으로 검증됩니다. 기존의 비대면방식보다 빠르고 효율적으로 진행됩니다.",
  "Country": "국가",
  "Zip Code": "우편번호",
  "State or Province": "도/시",
  "City": "시",
  ...
  // Attestation
  "Scan this QR Code using the uPort App": "Hopae앱으로 위 QR코드를 스캔하세요",
  "Check your device": "핸드폰을 확인해보세요",
  "Not receiving the request?": "아무일도 일어나지 않나요?",
  "No verified information to receive": "유효한 인증서를 받지 못했습니다",
  "This information will be stored in your app": "다음 항목들이 앱에 저장됩니다",
  "Subject": "발급대상",
  "Tap to open in a mobile browser": "여길 눌러서 모바일 브라우저에서 여세요",
  "You're Interacting with": "현재 이용하시는 서비스",
  "Verified information you'll receive": "인증서에 받으실 검증된 정보",
  "Done": "완료",
  "Back to Home": "Back to Home",
  "Tap 'Accept' in your uPort app to receive your claims": "Hopae앱에서 'Accept' 버튼을 눌러 저장하세요",

  // Success
  "Congratulations!": "발급완료!",
  "You received your": "지금부터 바로 사용가능: ",
  "Your claims are stored in your uPort app": "모든 정보들은 Hopae앱에 저장되었습니다.",
  "Services that honor": "아래 서비스에서 사용할 수 있습니다.",
  "Back to Dashboard": "돌아가기",

  // LikeDemo
  "Like the demo?": "데모가 어떠신가요?",
  "Build user-centric trusted data apps with uPort": "Hopae로 유저중심의 신뢰하는 데이터관리 앱을 만들어보세요",
  "Issue, request and verify information about your users": "",
  "View Documentation": "View Documentation",
  "Issue verified information to citizens in your city": "도시에 살고있는 주민들에게 검증된 정보를 발급하세요",
  "Build trusted data ecosystem in your city": "신뢰할만한 데이터 생태계를 만드세요. 시민들의 정보를 보호하는 동시에 경제도 활성화 할 수 있습니다.",
  "Contact Us": "Contact Us",

  // City/ClaimExists
  "regnClaimExists": "이미 제주도민증이 있으신것 같아요",
  ...
  "Get a digital verification of your": "다음 항목을 디지털로 발급받으세요:",
  "Let's make sure you have access to your claims whenever and wherever you need them": "필요한 곳에서 언제나 편하게 본인인증을 할 수 있습니다.",

  // University
  "diplomaDetail1": "성적증명서를 발급받을 수 있습니다. 간단히 발급받아서 다음 직장 인터뷰나 대학원에 진학하는데 사용하세요.",
  "diplomaDetail2": "세계 어디서나 통용되는 국제학생증으로 어디서나 학생 혜택을 받을 수 있습니다.",

  // Transport
  "transportDetail1": "제주도청에서는 도민들을 위해 매달 대중교통 금액을 지원합니다. 매월 교통지원비를 받으세요.",

  // Pharmacy
  "pharmacyDetail1": "어디든 간편하게 약을 처방받으세요. 인터넷 진료 후 어느 약국에서나 사용 가능합니다.",

  // Museum
  "museumDetail1": "제주도청에서는 도민들을 위해 국내 명소들 무료관람을 지원합니다. 연간 멤버십을 받아 쉽게 다니세요.",

  // Insurance
  "insuranceDetail1": "전세계 어디서나 동일한 의료보험 혜택을 받으세요. 모든 의료시설과 약국에서 사용 가능합니다.",

  // Company
  "companyDetail1": "재직증명서를 간편하게 발급받으세요. 대출이나 이직을 위해서 번거롭게 공증받거나 기관에 방문할 필요가 없습니다.",
  "companyDetail2": "다른 회사에 지원시 연봉, 경력 등을 쉽게 공유 할 수 있습니다.",
};
